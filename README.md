...
> Current release candidate: `1.0.0-rc.2`. It is published as a public prerelease for real desktop, Homebrew, IDE, update, sync, and reverse-output validation before `1.0.0`. Keep backups of important skill registries and review every sync or IDE connection plan before applying it.
